...
urlpatterns = [
    ...
    path('vecinos/modificar/<int:pk>', views.VecinosUpdateView.as_view(), name= 'Modificar_vecino'),
    path('vecinos/eliminar/<int:pk>', views.VecinosDeleteView.as_view(), name= 'Eliminar_vecino'),
    path('vecinos/detalle/<int:pk>', views.VecinosDetailView.as_view(), name= 'Detalle_vecino'),
    # path(r'^(?P<pk>\d+)$', views.VecinosDetailView.as_view(), name= 'Detalle_vecino'),
    # path(r'^nuevo$', views.VecinosCreateView.as_view(), name= 'Crear_vecino'),
    # path(r'^editar/(?P<pk>\d+)$', views.VecinosUpdateView.as_view(), name= 'Modificar_vecino'),
    # path(r'^borrar/(?P<pk>\d+)$', views.VecinosDeleteView.as_view(), name= 'Eliminar_vecino'),    
